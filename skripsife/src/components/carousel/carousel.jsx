...
import PICT1 from '../../images/img-banner1.png';
import PICT2 from '../../images/img-banner2.png';
import PICT3 from '../../images/img-banner3.png';
...
export function Carousel() {
    ...
    return (
        <>
        {/* <div className="container" style={{height:"150%", marginLeft:"50px"}}> */}
            <div className="sliderCarousel" style={{marginLeft:"100px"}}>
                <OwlCarousel items={1}
                ...
                >
                    ...
                    <div className="item">
                        <div className="slider2">
                            <img src={PICT2} className="image2" alt="Foto produk" />
                        </div>
                    </div>
                    <div className="item">
                        <div className="slider3">
                            <img src={PICT3} className="image3" alt="Foto produk" />
                        </div>
                    </div>
